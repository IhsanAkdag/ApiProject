...
public class Get09 extends HerOkuAppBaseUrl {
   ...
   */
    ...
    public void name() {
        // set the url
        specification.pathParams("first","booking","second",2279);
        ...
        assertEquals(bookingdatesMap.get("checkout"),((Map)actualData.get("bookingdates")).get("checkin"));
    ...
    public void dynamicWay() {
        //Set the URL
        specification.pathParams("first","booking","second",794);
